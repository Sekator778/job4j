...
+ [20. Стек и куча в Java](#1-Стек-и-куча-в-Java)
...
Менеджер памяти — часть системы (программы или ОС), обрабатыващая запросы на выделение и освобождения оперативной памяти.
